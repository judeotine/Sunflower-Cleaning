...
const testimonials = [
  {
    ...
    rating: 5,
    image: "https://mega.nz/file/YtxAUBoI#71FQMPCCLi-xzd4aLpCjI8O2yK0ImpGCy-4S1tycXtc",
    featured: true,
  ...
  return (
    <>
      ...
      <div className="pt-24 bg-gradient-to-b from-sunflower-50 to-white">
        <div className="container mx-auto px-4 py-16 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Our Customer <span className="text-sunflower-500">Testimonials</span>
          </h1>
            ...
            {testimonials
              ...
              .map((testimonial) => (
                ...
                >
                      ...
                      <div className="flex mt-1">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`w-4 h-4 ${
                              i < testimonial.rating ? "text-sunflower-500 fill-sunflower-500" : "text-gray-300"
                            }`}
                          />
                        ))}
                      </div>
                  ...
                  <p className="text-sm text-sunflower-600">Service: {testimonial.service}</p>
                </div>
              ))}
          </div>
        </div>
      ...
      <Section className="bg-gray-50">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-center mb-6">All Customer Reviews</h2>
          ...
          {filteredTestimonials.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500">No reviews found for this filter. Please try another category.</p>
            </div>
          )}
        </div>
      </Section>
      ...
      <Section className="bg-white">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Our commitment to quality, reliability, and exceptional service has earned us 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
          <div className="bg-sunflower-50 rounded-lg p-6 text-center">
            <div className="text-4xl font-bold text-sunflower-500 mb-2">98%</div>
            <p className="text-gray-700">Customer Satisfaction</p>
          </div>
          <div className="bg-sunflower-50 rounded-lg p-6 text-center">
            <div className="text-4xl font-bold text-sunflower-500 mb-2">4.9</div>
            <p className="text-gray-700">Average Rating</p>
          </div>
          <div className="bg-sunflower-50 rounded-lg p-6 text-center">
            <div className="text-4xl font-bold text-sunflower-500 mb-2">87%</div>
            <p className="text-gray-700">Recurring Customers</p>
          </div>
          <div className="bg-sunflower-50 rounded-lg p-6 text-center">
            <div className="text-4xl font-bold text-sunflower-500 mb-2">2000+</div>
      ...
      <Section className="bg-gray-50">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Are you a satisfied customer? We'd love to hear about your experience with Sunflower Cleaning & Laundry Services.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-sunflower-500 hover:bg-sunflower-600">
      ...
      <Section fullWidth className="bg-sunflower-500 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to experience our 5-star service?</h2>
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Join our community of satisfied customers and see the Sunflower difference for yourself.
          </p>
